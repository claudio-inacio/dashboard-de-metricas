...
const AnalyticTypeCard = ({ title, description, image, handleFunction, buttontitle, titleColor, buttonColor }: AnalyticTypeCardProps) => {
    return (
        <div
            ...
            className=" max-w-[350px] flex w-full flex-col items-center justify-center gap-2 py-6 bg-gray-100 rounded-lg shadow-lg w-full">
            ...
            <Button buttontitle={buttontitle} variant="contained" color={buttonColor} handleFunction={handleFunction} />
        </div>
    )
}
